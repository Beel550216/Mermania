...
namespace Player
{
    ...
    public class Traders : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            npcDialogues.Add("It's been 10 minutes, where's Jane?");
            ...
            npcDialogues.Add("Talk to Jane (the girl in yellow)"); //her friend

            npcDialogues.Add("Am I Jane? What? No, you must be looking for a different girl in yellow.");

            npcDialogues.Add("Am I Jane? Yes, why?");
            ...
            npcDialogues.Add("Yeah, you don't actually believe that, right, Emma?"); //Girl2
            ...
            npcDialogues.Add("Em! Don't tell me you're going crazy too!"); //Girl2
            ...
            npcDialogues.Add("Whatever you say, Emma."); //Girl2


            npcName.Add("Girl A");
            npcName.Add("Girl B");
            npcName.Add("Not Jane");
            npcName.Add("Jane?");
